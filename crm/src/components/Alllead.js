...
function Alllead() {
    return (
        <div style={{ width: "100%" }}>
            ...
            <div style={{ backgroundColor: 'green', marginTop: '6px', padding: '10px' }}>
...
<div style={{ display: 'flex', marginTop: '10px', padding: '10px',height:'500px',
  ...
  <div style={{ flex: 1, display: 'flex',
    ...
    <h6 style={{marginLeft:'10px',marginTop:'10px'}}>Filter Leads By </h6>
  ...
  <div className="collapse mt-2" id="collapseCheckbox2">
    <ul style={{ listStyle: 'none', paddingLeft: 0 }}>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-1" />
          <label className="form-check-label" htmlFor="option1-1">Annual Revenue</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-2" />
          <label className="form-check-label" htmlFor="option1-2">City</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Company</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Converted Contact</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Converted Deal</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Country</label>
        </div>
      </li>
      <li>
        <div className="form-check">
      ...
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Email</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Email Opt Out</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Fax</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">First Name</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Industry</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Last Activity Time</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Last Name</label>
        </div>
      </li>
      <li>
        <div className="form-check">
      ...
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Lead Name</label>
        </div>
      </li>
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Lead Owner</label>
        </div>
      </li>
      <li>
        <div className="form-check">
      ...
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Lead Status</label>
        </div> </li>
      ...
      <li>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" id="option1-3" />
          <label className="form-check-label" htmlFor="option1-3">Mobile</label>
        </div>
      </li>
      <li>
        <div className="form-check">
      ...
      <tbody>
        {[...Array(20)].map((_, index) => (
          <tr key={index}>
            ...
            <td>ABC Corp</td>
            <td>john{index + 1}@example.com</td>
            <td>+1 234 567 890{index}</td>
            <td>Website</td>
            <td>Sales Team</td>
          </tr>
        ))}
