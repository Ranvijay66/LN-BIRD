  ...
  return (
    <div style={{ width: "100%" }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            ...
            <div className="dropdown">
              ...
              <ul className="dropdown-menu" style={{ position: "absolute", right: 0 }}>
                ...
                <li className="dropdown-item"><b>Canvas View</b></li>
      ...
      <div style={{ display: 'flex', marginTop: '10px', padding: '10px', height: '500px' }}>
        {/* Left Panel Filters */}
        <div style={{  display: 'flex', flexDirection: 'column', gap: '10px', borderRadius: '10px', overflowY: 'auto', backgroundColor: 'green' }}>
          <h6 style={{ marginLeft: '10px', marginTop: '10px' }}>Filter Accounts By</h6>
          ...
          {renderFilterSection("System Defined Filters", "collapseCheckbox1", [
            "Touched Records", "Untouched Records", "Record Action", "Related Records Action", "Latest Email Status", "Activities", "Campaigns"
          ])}

          {renderFilterSection("Filter Contacts By", "collapseCheckbox2", [
            "Annual Revenue", "City", "Company", "Converted Contact", "Converted Deal", "Country", "Created BY", "Created Time",
            "Email", "Email Opt Out", "Fax", "First Name", "Industry", "Last Activity Time", "Last Name", "Lead Convertion Time",
            "Lead Name", "Lead Owner", "Lead Source", "Lead Status", "Mobile", "Modified By", "Modified Time", "No of Employees",
            "Phone", "Rating", "Solution", "Secondary Email", "Skype ID", "State", "Title", "Unsubscribe Mode", "Unsubscribe Time", "Website", "Zipcode"
          ])}

          {renderFilterSection("Filter By Related Modules", "collapseCheckbox3", [
            "Calls", "Invitees (Invited Meetings)", "Meetings", "Notes", "Tasks"
          ])}
        </div>

        {/* Right Panel */}
        <div style={{ flex: 3, paddingLeft: '20px', maxHeight: '500px', overflowY: 'auto',
           display: 'flex', flexDirection: 'column', gap: '20px'  }}>
          {showKanban && (
            <div style={{ border: '1px solid #ccc', borderRadius: '10px', padding: '15px', marginBottom: '20px', backgroundColor: '#f7f7f7' }}>
              <h5>Not Started</h5>
              <div style={{ display: 'flex', gap: '20px', overflowX: 'auto' }}>
                <div style={{
                  ...
                  <strong>Register for upcoming  CRM Webinar</strong><input type="checkbox"  />
                  <p>20/3/2025</p>
                  <p>Low</p>
                ...
                <div style={{
                  ...
                  <strong>Competitor Comparision Document</strong><input type="checkbox"  />
                  <p>18/3/2025</p>
                  <p>Highest</p>
                  <p>dev.papayapalette</p>
  ...
  <label htmlFor="task3" style={{ margin: 0 }}>
    ...
    <p>Chapman(sample)</p>
          ...
          <div style={{ textAlign: 'center', marginTop: '20px' }}>
            <button className="btn btn-info" onClick={() => setShowKanban(!showKanban)}>
              {showKanban ? "NOT STARTED" : " NOT STARTED"}
            </button>
          </div>

          <div style={{ textAlign: 'center', marginTop: '-20px' }}>
            <button className="btn btn-info" onClick={() => setShowKanban1(!showKanban1)}>
        ...
        {items.map((label, idx) => (
          <li key={idx}>
            <div className="form-check">
              <input className="form-check-input" type="checkbox" id={`${collapseId}-option-${idx}`} />
              <label className="form-check-label" htmlFor={`${collapseId}-option-${idx}`}>{label}</label>
            </div>
          </li>
        ))}
      </ul>
