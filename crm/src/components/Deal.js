  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      <form style={{ marginTop: "50px", marginLeft: "30px" }}>
        ...
        <label style={{ marginLeft: "13PX", marginTop: "10px" }}>
          Account Name
          <input
            type="text"
            name="firstName"
        ...
        <label style={{ marginLeft: "43PX", marginTop: "10px" }}>
          Next step&nbsp;{" "}
          <input
            type="text"
            name="firstName"
