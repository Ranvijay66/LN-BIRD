  ...
  />
    ...
    <div style={{ marginBottom: '5px' }}>
      ...
      <input
        ...
        className="input-light-border"
      />
      <small> <i style={{fontSize:"15px", opacity:"0.6"}}>Press enter to add new children</i></small>
    </div>
    ...
    >
      <thead>
        <tr style={{ opacity: 0.2 }}>
          ...
          <th style={{ textAlign: 'left', padding: '10px', paddingLeft: '500px' }}>Name</th>
          <th style={{ textAlign: 'left', padding: '10px', paddingLeft: '300px' }}>Item</th>
